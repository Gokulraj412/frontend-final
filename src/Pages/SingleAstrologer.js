...
function SingleAstrologer(props) {
    ...
    <main className="card profile_container">
      ...
      <article  className="profile_detail">
        ...
        <div className="my-4">
          <h5>Photo</h5>
          <div className="img">
          <img src={astrologers?.astrologer?.profilePic[0]?.pic} alt={astrologers?.astrologer?.profilePic[0]?._id} />
          {/* <img src=" http://localhost:8000/uploads/profilepic/60561.jpg" alt="" /> */}
            {/* <img src="http://127.0.0.1:8000/uploads/profilepic/170020096968060561.jpg" alt={astrologers?.astrologer?.profilePic[0]?._id} /> */}
          </div>
        </div>
        <div className="my-4">
          <h5>Gender</h5>
        ...
        <div className="my-4">
          ...
          {astrologers?.astrologer?.certificates.map((file)=>(
             <img src={file.file} alt={file._id} />
          ))} 
      ...
      <div className="btnGroup">
          ...
          <button className="btns" onClick={()=> navigate(`/edit-astrologer/${astrologers?.astrologer?._id}`)}>Edit</button>
