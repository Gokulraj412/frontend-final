                    ...
                    <article className="basicDetails">
                        ...
                        <div className="twoCol">
                            ...
                            <div className="mb-3" >
                                <FloatingLabel
                                    ...
                                    label="First Name"
                                >
                                    <Form.Control type="text" placeholder="firstname" name="firstname" {...register("firstname", validation.firstname)} defaultValue={astrologers?.astrologer?.firstname}  />
                                </FloatingLabel>
                            ...
                            <div className="mb-3">
                                <FloatingLabel
                                    ...
                                    label="Last Name"
                                >
                                    <Form.Control type="text" placeholder="lastname" name="lastname" {...register("lastname", validation.lastname)} defaultValue={astrologers?.astrologer?.lastname} />
                                </FloatingLabel>
                                <p className="errormsg">
                        ...
                        <div className="threeCol">
                            ...
                            <div>
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DemoContainer components={['DatePicker']}  >
                                        <DatePicker label="Date of Birth" className="mb-3"  onChange={(newValue) => setDob(newValue)} />
                                    </DemoContainer>
                            ...
                            <div className="mb-3">
                                <div className="mx-2">
                                    ...
                                    <Form.Check type="radio" label="Male" name="gender" inline id="inline-radio-1" defaultChecked={astrologers?.astrologer?.gender === "male"} {...register("gender", validation.gender)} />
                                    <Form.Check type="radio" label="Female" name="gender" inline id="inline-radio-2"  defaultChecked={astrologers?.astrologer?.gender === "female"}  {...register("gender", validation.gender)} />
                                    <Form.Check type="radio" label="Others" name="gender" inline id="inline-radio-3" defaultChecked={astrologers?.astrologer?.gender === "others"}  {...register("gender", validation.gender)} />
                                </div>
                                <p className="errormsg">
                        ...
                        <div className="threeCol">
                            ...
                            <div className="mb-3">
                                <FloatingLabel
                                    ...
                                    label="Email address"
                                >
                                    <Form.Control type="email" placeholder="name@example.com" name="email" {...register("email", validation.email)} defaultValue={astrologers?.astrologer?.email}  />
                                </FloatingLabel>
                                <p className="errormsg">
                            ...
                            <div className="mb-3">
                                ...
                                >
                                    <Form.Control type="tel" placeholder="mobilePrimary" name="mobilePrimary" {...register("mobilePrimary", validation.mobilePrimary)} defaultValue={astrologers?.astrologer?.mobilePrimery}  />
                                </FloatingLabel>
                                <p className="errormsg">
                            ...
                            <div className="mb-3">
                                ...
                                >
                                    <Form.Control type="tel" placeholder="mobileSecondary" name="mobileSecondary" {...register("mobileSecondary", validation.mobileSecondary)} defaultValue={astrologers?.astrologer?.mobileSecondry} />
                                </FloatingLabel>
                                <p className="errormsg">
                        ...
                        <div className="twoCol">
                            ...
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control type="text" placeholder="qualifications" name="qualifications" {...register("qualifications")} defaultValue={astrologers?.astrologer?.qualifications}  />
                            </FloatingLabel>
                            ...
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control type="text" placeholder="address" name="address" {...register("address")} defaultValue={astrologers?.astrologer?.address}  />
                            </FloatingLabel>
                        </div>
                        <div className="twoCol">
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control type="text" placeholder="District" name="district" {...register("district")} defaultValue={astrologers?.astrologer?.district} />
                            </FloatingLabel>
                            <FloatingLabel
                                controlId="state"
                                label="State"
                                className="mb-3"
                            >
                                <Form.Control type="text" placeholder="State" name="state" {...register("state")} defaultValue={astrologers?.astrologer?.state}  />
                            </FloatingLabel>
                        </div>
                        <div className="twoCol">
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control type="text" placeholder="Country" name="country" {...register("country")} defaultValue={astrologers?.astrologer?.country} />
                            </FloatingLabel>
                            <FloatingLabel
                                controlId="pincode"
                                label="Pincode"
                                className="mb-3"
                            >
                                <Form.Control type="tel" placeholder="Pincode" name="pincode" {...register("pincode")} defaultValue={astrologers?.astrologer?.pincode}  />
                            </FloatingLabel>
                        </div>
                    </article>
                    <hr />
                    <article className="astroDetails my-3">
                        ...
                        <div className="threeCol">
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control type="text" placeholder="institute" name="institute" {...register("institute")}  defaultValue={astrologers?.astrologer?.institute} />
                            </FloatingLabel>
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control type="number" placeholder="experience" name="experience" {...register("experience")}  defaultValue={astrologers?.astrologer?.experience} />
                            </FloatingLabel>
                            <div>
                                <FloatingLabel
                        ...
                        <div>
                            <div className="mb-3">
                                ...
                                >
                                    <Form.Control as="textarea" style={{ height: '100px' }} placeholder="astrology-description" name="astrologyDescription" {...register("astrologyDescription", validation.astrologyDescription)}  defaultValue={astrologers?.astrologer?.astrologyDescription} />
                                </FloatingLabel>
                                <p className="errormsg">
                        ...
                        <div>
                            <div className="mb-3">
                                ...
                                >
                                    <Form.Control as="textarea" style={{ height: '100px' }} placeholder="astrology-experience" name="astrologyExperience" {...register("astrologyExperience", validation.astrologyExperience)}  defaultValue={astrologers?.astrologer?.astrologyExperience} />
                                </FloatingLabel>
                                <p className="errormsg">
                        ...
                        <div>
                            <div className="mb-3">
                                ...
                                >
                                    <Form.Control as="textarea" style={{ height: '100px' }} placeholder="astrology-expertise" name="astrologyExpertise" {...register("astrologyExpertise", validation.astrologyExpertise)} defaultValue={astrologers?.astrologer?.astrologyExpertise} />
                                </FloatingLabel>
                                <p className="errormsg">
                        ...
                        <div>
                            <div className="mb-3">
                                ...
                                >
                                    <Form.Control as="textarea" style={{ height: '100px' }} placeholder="Know-us" name="knowus" {...register("knowus", validation.knowus)} defaultValue={astrologers?.astrologer?.knowus}  />
                                </FloatingLabel>
                                <p className="errormsg">
                        ...
                        <FloatingLabel
                            controlId="maxTime"
                            label="Maximum time you can spent in Astro5Star per day (in Hrs)"
                            className="mb-3"
                        >
                            <Form.Control type="number" placeholder="maxTime" name="maxTime" {...register("maxTime")}  defaultValue={astrologers?.astrologer?.maxTime} />
                        </FloatingLabel>
