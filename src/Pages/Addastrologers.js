                                ...
                                <div>
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <DemoContainer components={['DatePicker']}  >
                                            <DatePicker label="Date of Birth" className="mb-3" value={dob} onChange={(newValue) => setDob(newValue)} />
                                        </DemoContainer>
                        ...
                        <article className="astroDetails my-3">
                            ...
                            <div className="threeCol">
                                <FloatingLabel
                                    ...
                                    className="mb-3"
                                >
                                    <Form.Control type="text" placeholder="institute" name="institute" {...register("institute")} />
                                </FloatingLabel>
                                <FloatingLabel
